...
function StatCard({ title, value, large }: { title: string; value: string; large?: boolean }) {
  return (
    <div className="bg-[#d8d0ce] rounded-[18px] p-[20px] flex flex-col gap-[8px]">
      <p className="text-[#8f92a9] text-[15px] tracking-[-0.5px]">{title}</p>
  ...
  return (
    <div className="bg-[#d8d0ce] rounded-[24px] p-[40px] flex flex-col items-center justify-center gap-[16px]">
      <div className="flex items-center gap-[8px]">
        <span className="text-[#545b7f] text-[20px] tracking-[-0.5px]">
          {mode === "focus" ? "Focusing" : "Break"}
        </span>
        <span className="text-[#8f92a9] text-[20px]">→</span>
        <span className="text-[#8f92a9]/40 text-[20px] tracking-[-0.5px]">
...
function TodaysPomos() {
  ...
  return (
    <div className="bg-[#d8d0ce] rounded-[18px] p-[20px] flex flex-col gap-[8px]">
      <p className="text-[#8f92a9] text-[15px] tracking-[-0.5px]">Today&apos;s Pomos</p>
  ...
  return (
    <div className="bg-[#d8d0ce] rounded-[18px] p-[20px] flex flex-col gap-[12px]">
      <div className="flex items-end justify-between">
        <div>
          <p className="text-[#8f92a9] text-[15px] tracking-[-0.5px]">Daily Average</p>
          <p className="text-[#545b7f] text-[28px] tracking-[-1px] leading-none mt-[4px]">1h 8m</p>
        </div>
        <div className="flex items-center gap-[4px]">
          <span className="text-[#8f92a9] text-[15px]">‹</span>
          <span className="text-[#545b7f] text-[13px] tracking-[-0.5px]">This week</span>
          <span className="text-[#8f92a9]/30 text-[15px]">›</span>
        </div>
      </div>
...
function FocusLog() {
  return (
    <div className="bg-[#d8d0ce] rounded-[18px] p-[20px] flex flex-col gap-[8px]">
      <p className="text-[#8f92a9] text-[15px] tracking-[-0.5px]">Focus Log</p>
...
function YearHeatmap() {
  return (
    <div className="bg-[#d8d0ce] rounded-[18px] p-[20px] flex flex-col gap-[8px]">
      <p className="text-[#8f92a9] text-[15px] tracking-[-0.5px]">Year Overview</p>
...
function SettingsPanel() {
  return (
    <div className="bg-[#d8d0ce] rounded-[18px] p-[20px] flex flex-col gap-[16px]">
      <p className="text-[#8f92a9] text-[15px] tracking-[-0.5px]">Settings</p>
      {[
        ...
        <div key={s.label} className="flex items-center justify-between">
          <span className="text-[#545b7f] text-[15px] tracking-[-0.5px]">{s.label}</span>
      ...
      <div className="border-t border-[#c2c9dc]/30 pt-[12px] flex items-center gap-[8px]">
        ...
        <span className="text-[#545b7f] text-[15px] tracking-[-0.5px] truncate">sparkmarkphotos@gmail.com</span>
        <span className="text-[#8f92a9] text-[13px] tracking-[-0.5px] underline ml-auto">Sign out</span>
      </div>
    </div>
  );
}
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col gap-[24px]">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-[8px]">
            ...
            <span className="text-[#8f92a9] text-[15px] tracking-[-0.5px]">Synced</span>
          </div>
        </div>
